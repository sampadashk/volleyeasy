 ...
 */
public class CircleBadgeView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2, getHeight() / 2, Math.min(getWidth() / 2, getHeight() / 2), mBgPaint);
        super.draw(canvas);
    }
